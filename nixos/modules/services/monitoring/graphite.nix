...
let
  ...
  carbonEnv = {
    PYTHONPATH = let
      ...
      cenvPack =  "${cenv}/${pkgs.python3.sitePackages}";
    ...
    (mkIf cfg.web.enable {
      systemd.services.graphiteWeb = {
        ...
        preStart = ''
          ...
          if ! [ "${dataDir}/current_graphite_web" -ef "${pkgs.pythonPackages.graphite-web}" ]; then
            mkdir -p ${staticDir}
      ...
      environment.systemPackages = [ python3Packages.graphite-web ];
    })
