  ...
  if localSystem.isAarch64 then
    let
      fetch = { file, sha256, executable ? true }: import <nix/fetchurl.nix> {
        url = "https://s3.ap-northeast-1.amazonaws.com/nix-misc.cons.org.nz/stdenv-darwin/aarch64/11df6e948def0d011d180948786c24d4a3b999ae/${file}";
        ...
        tarball = fetch { file = "bootstrap-tools.cpio.bz2"; sha256 = "04qpmvkvxi4k23579k7fykns9w8qs4ysq6gj6hmv0v45h4wq5gg7"; executable = false; };
      }
  else
    let
      fetch = { file, sha256, executable ? true }: import <nix/fetchurl.nix> {
