...
let
  ...
  libPath = lib.makeLibraryPath ([
    ...
    ++ lib.optional (stdenv.hostPlatform.isLinux && stdenv.hostPlatform.isAarch64) numactl);
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl ({
    ...
    x86_64-darwin = {
      ...
      sha256 = "0590y9ckw03j7cv89xvi1z15r5qisa4swz6kvypnjkp4frfz6d96";
    };
    aarch64-darwin = {
        url = "https://dl.dropbox.com/s/y9sanzhozm52nzd/ghc-8.10.3-aarch64-apple-darwin.tar.xz";
        sha256 = "0jg75f9wsal394qhc6vvma3liq08bhmvmgsx33swv3xj6q1yczv5";
    };
  ...
  postUnpack =
    ...
    lib.optionalString stdenv.isDarwin ''
      ...
      for exe in $(find . -type f -executable); do
        ...
        install_name_tool \
            -change /usr/lib/libiconv.2.dylib @executable_path/libiconv.dylib \
            $exe
      done
    '' +
